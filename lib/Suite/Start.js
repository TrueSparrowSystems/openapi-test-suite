    ...
    for (const path in oThis.allPaths) {
      ...
      for (const method in currentPath) {
        ...
        for (const param of methodParams) {
          ...
          const schemaTypeObj = ParamValueSetFactory.getInstance(schema, param.required);
          const paramCorrectValue = schemaTypeObj.correctValues();
          const paramCombinationsArray = paramCorrectValue.concat(paramCorrectValue.incorrectValues());
