...
class Start {
  ...
  // /**
  //  * Stores securityInfo in config.
  //  *
  //  * @returns {Promise<void>}
  //  */
  // async storeSecurityInfoInConfig() {
  //   const oThis = this;
  //
  //   const securityConfig = {};
  //   for (const securityAuth in oThis.securityInfo) {
  //     const securityAuthObj = oThis.securityInfo[securityAuth];
  //
  //     securityConfig[securityAuth] = {};
  //
  //     if (securityAuthObj.headers) {
  //       securityConfig[securityAuth].headers = securityAuthObj.headers;
  //     }
  //
  //     securityConfig[securityAuth].cookies = {};
  //
  //     for (const cookieName in securityAuthObj.cookies) {
  //       securityConfig[securityAuth].cookies[cookieName] = securityAuthObj.cookies[cookieName];
  //     }
  //
  //   }
  //
  //   configProvider.setConfig('securityInfo', securityConfig);
  // }
